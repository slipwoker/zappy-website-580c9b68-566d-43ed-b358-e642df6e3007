document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener(
      ...
      function (e) {
        ...
        if (
          ...
          !field.matches('[type="submit"], [type="button"], [type="reset"]')
        ) {
          validateField(field);
        }
      },
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Successful validation — show success state
  ...
  const animatedEls = document.querySelectorAll('.fade-in, .animate-on-scroll');
  ...
  const dataAnimateEls = document.querySelectorAll('[data-animate]');

  if (dataAnimateEls.length > 0) {
    const dataObserver = new IntersectionObserver(
      function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            const animationClass =
              entry.target.getAttribute('data-animate') || 'is-visible';
    ...
    dataAnimateEls.forEach(function (el) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מוניות אבי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '580c9b68-566d-43ed-b358-e642df6e3007',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '580c9b68-566d-43ed-b358-e642df6e3007';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '580c9b68-566d-43ed-b358-e642df6e3007';
